...
- **Bulk spreadsheet editing** — every standard WooCommerce product field in one table: name, SKU, price, sale price, stock, weight, dimensions, status, visibility, categories, tags, attributes, description, and more
...
- More robust product catalogue filtering (by status, category, tag, stock status, price range, product type, date modified, name/SKU search) directly from within the editor
